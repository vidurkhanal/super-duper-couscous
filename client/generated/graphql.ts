...
export type DeleteCredentialMutation = {
  ...
  delCredentials: {
    ...
    user?: Maybe<{
      ...
      fullName: string;
      credentials?: Maybe<
        Array<{ __typename?: "Credential"; email: string; password: string }>
      >;
    }>;
  };
};
...
export function useChangeMasterPinMutation() {
  return Urql.useMutation<
    ChangeMasterPinMutation,
    ChangeMasterPinMutationVariables
  >(ChangeMasterPinDocument);
}
