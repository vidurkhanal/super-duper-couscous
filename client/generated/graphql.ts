...
export type LoginUserMutation = { __typename?: "Mutation" } & {
  loginUser: { __typename?: "AuthResponse" } & Pick<AuthResponse, "error"> & {
...
export type GetCredentialsQuery = { __typename?: "Query" } & {
  getCredentials?: Maybe<
    Array<
      { __typename?: "Credential" } & Pick<
        Credential,
        "credentialID" | "email" | "password"
      >
    >
  >;
};
...
export type MeQuery = { __typename?: "Query" } & {
  me?: Maybe<
    { __typename?: "User" } & Pick<User, "userID"> & {
        credentials?: Maybe<
          Array<
            { __typename?: "Credential" } & Pick<
              Credential,
...
export function useGetCredentialsQuery(
  options: Omit<Urql.UseQueryArgs<GetCredentialsQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<GetCredentialsQuery>({
    query: GetCredentialsDocument,
    ...options,
  });
}
...
export function useHelloQueryQuery(
  options: Omit<Urql.UseQueryArgs<HelloQueryQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<HelloQueryQuery>({
