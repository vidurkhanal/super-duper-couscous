...
export type AddCredentialMutation = { __typename?: "Mutation" } & {
  addCredential: { __typename?: "CredentialResponse" } & Pick<
    CredentialResponse,
    "error"
  > & {
      user?: Maybe<
        { __typename?: "User" } & Pick<User, "userID" | "fullName"> & {
            credentials?: Maybe<
              Array<
...
export type DeleteCredentialMutation = { __typename?: "Mutation" } & {
  delCredentials: { __typename?: "CredentialResponse" } & Pick<
    CredentialResponse,
    "error"
  > & {
      user?: Maybe<
